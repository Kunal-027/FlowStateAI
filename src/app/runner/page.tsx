    ...
    <div className="flex flex-col gap-4 border-t border-border pt-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="rounded-md border border-border bg-muted/30 px-3 py-2 font-mono text-xs text-muted-foreground">
          ...
          <p className="mb-1">App: <code className="rounded bg-muted px-1.5 py-0.5">npm run dev</code> — then open <code className="rounded bg-muted px-1.5 py-0.5">localhost:3001</code></p>
